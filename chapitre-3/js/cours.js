...
var lientElt = document.createElement("a");
lientElt.href="https://fr.wikipedia.org/wiki/Liste_des_langages_de_programmation";
lientElt.textContent="liste";
paraElt.appendChild(document.createTextNode("Voici une "));
paraElt.appendChild(lientElt);
